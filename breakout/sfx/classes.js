...
export class upBall extends Ball {
  move() {
    this.vy += this.grav;
    if (this.y <= this.r) {
      let ogBall = balls[0];
...
export class downBall extends Ball {
  move() {
    this.vy -= this.grav;
    super.move();
  }
...
export class extraBall extends PowerUp {
  effect() {
    let og = balls[0];
...
export class upGravity extends PowerUp {
  effect() {
    let ogBall = balls[0];
    balls.length = 0;
...
export class downGravity extends PowerUp {
  effect() {
    let ogBall = balls[0];
    balls.length = 0;
...
export class curveEffect extends PowerUp {
  effect() {
    let ogBall = balls[0];
    balls.length = 0;
